...
class WebsocketTest {
    ...
    val testMessage = Message(UUID.fromString("5d4549f9-4bcb-458d-a7fc-15274ff24bc8"),
            UUID.fromString("9a70ca8c-55e7-4ccb-b8cd-aa34d732e77f"),
            "content",
            UUID.fromString("a43d0f78-8f5c-4226-9898-128c33af862b")
    )
